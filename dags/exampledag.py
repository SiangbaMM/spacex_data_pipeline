...
![Picture of the ISS](https://www.esa.int/var/esa/storage/images/esa_multimedia\
    /images/2010/02/space_station_over_earth/10293696-3-eng-GB/\
...
def example_astronauts():
    # Define tasks
    @task(
        # Define a dataset outlet for the task. This can be used to 
        # schedule downstream DAGs when this task has run.
