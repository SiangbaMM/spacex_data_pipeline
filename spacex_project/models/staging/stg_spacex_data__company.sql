...
(
    select
	    ...
	    nullif(founded, -999999999) as company_founding_date,
	    nullif(employees, -999999999) as company_employee_count,
	    nullif(vehicles, -999999999) as company_vehicle_count,
	    nullif(launch_sites, -999999999) as company_launch_site_count,
	    nullif(test_sites, -999999999) as company_test_site_count,
	    ceo as company_ceo,
	    cto as company_cto,
	    coo as company_coo,
	    cto_propulsion as company_cto_propulsion,
	    nullif(valuation, -999999999) as company_valuation,
