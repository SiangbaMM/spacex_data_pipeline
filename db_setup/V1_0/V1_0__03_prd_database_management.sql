...
CREATE DATABASE IF NOT EXISTS spacex_data_prd COMMENT = 'SpaceX Data database of production environment';

GRANT OWNERSHIP ON DATABASE spacex_data_prd TO ROLE spacex_data_prd_sysadmin
WITH
    GRANT OPTION;
...
-- Étape 4 : Attribution des privilèges pour 'spacex_data_prd'
USE ROLE SECURITYADMIN;

GRANT CREATE USER,
CREATE ROLE ON ACCOUNT TO ROLE spacex_data_prd_secadmin;

--GRANT USAGE, MONITOR ON DATABASE spacex_data_prd TO ROLE spacex_data_prd_secadmin;
-- Étape 7 : Vérification des privilèges
SHOW GRANTS ON DATABASE spacex_data_prd;
