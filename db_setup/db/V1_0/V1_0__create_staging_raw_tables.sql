...
USE ROLE {{ env_var('SNOWFLAKE_DATABASE') }}_SYSADMIN ;

USE DATABASE {{ env_var('SNOWFLAKE_DATABASE') }} ;

USE SCHEMA STAGING ;

-- Staging table for capsules
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_CAPSULE (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_COMPANY (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_CORE (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_CREW (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_DRAGON (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_HISTORY (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_LANDPAD (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_LAUNCH (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_LAUNCHPAD (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_PAYLOAD (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_ROADSTER (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_ROCKET (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_SHIP (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_STARLINK (
...
CREATE TABLE
    IF NOT EXISTS STG_SPACEX_DATA_LOAD_ERRORS (
