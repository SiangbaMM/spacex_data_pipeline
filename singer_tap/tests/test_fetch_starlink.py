...
@pytest.fixture
def starlink_tap():
    return StarlinkTap(base_url="https://api.spacexdata.com/v4/", config_path="config_snowflake.json")
...
SAMPLE_STARLINK_DATA = [
    {
        ...
        "spaceTrack": {
            ...
            "TLE_LINE1": "1 44713U 20001A   24001.41666667  .00000001  00000-0  10000-3 0  9999",
            "TLE_LINE2": "2 44713  53.0000 180.0000 0001000  90.0000 270.0000 15.06000000 12340"
        }
    }
]
...
def test_fetch_starlink_state_management():
    ...
    with patch('requests.get') as mock_get, \
        ...
        assert new_state['bookmarks']['starlink']['last_record'] > '2024-01-01T00:00:00Z'
