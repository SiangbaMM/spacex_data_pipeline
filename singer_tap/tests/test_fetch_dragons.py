...
from singer_tap.include.fetch_dragons import DragonsTap


@pytest.fixture
def dragons_tap():
    """Instanciate dragons_tap
...
def test_fetch_dragons_state_management():
    ...
    with (
        ...
        mock_get_state.return_value = {
            "bookmarks": {"dragons": {"last_record": "2024-01-01T00:00:00Z"}}
        }
    ...
    multiple_dragons_data = [
        {
            ...
            "active": False,
            "crew_capacity": 0,
            "thrusters": [{"type": "Draco", "amount": 18}],
        },
        {
            "id": "dragon2",
            "name": "Dragon 2",
            ...
            "crew_capacity": 7,
            "thrusters": [
                {"type": "Draco", "amount": 16},
                {"type": "SuperDraco", "amount": 8},
            ],
        },
    ]
