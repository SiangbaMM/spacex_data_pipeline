...
from singer_tap.include.fetch_launches import LaunchesTap


@pytest.fixture
def launches_tap():
    """Instanciate launches_tap
...
SAMPLE_LAUNCH_DATA = [
    {
        ...
        "links": {
            ...
            "article": "https://www.space.com/2196-spacex-inaugural-falcon-1-rocket-lost-launch.html",  # noqa: E501
...
def test_fetch_launches_missing_nested_data():
    ...
    with (
        ...
        # Verify record was written with empty JSON arrays/objects
        # for missing nested data
        record_call = mock_write_record.call_args[1]
        record = record_call["record"]
...
def test_fetch_launches_pagination():
    ...
    with (
        ...
        second_page.json.return_value = {
            "docs": [
                {**SAMPLE_LAUNCH_DATA[0], "id": "second_launch", "flight_number": 2}
            ],
            "totalDocs": 2,
            "offset": 1,
            "limit": 1,
...
def test_fetch_launches_incremental_sync():
    ...
    with (
        ...
        mock_get_state.return_value = {
            "bookmarks": {"launches": {"last_record": "2024-01-01T00:00:00Z"}}
        }
        ...
        assert (
            new_state["bookmarks"]["launches"]["last_record"] > "2024-01-01T00:00:00Z"
        )
