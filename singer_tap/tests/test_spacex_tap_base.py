...
@pytest.fixture
def spacex_tap_base():
    return SpaceXTapBase(base_url="https://api.spacexdata.com/v4/", config_path="config.json")
...
def test_state_management(spacex_tap_base):
    ...
    with patch('builtins.open', create=True) as mock_open:
        ...
        written_data = json.loads(mock_open.return_value.__enter__.return_value.write.call_args[0][0])
